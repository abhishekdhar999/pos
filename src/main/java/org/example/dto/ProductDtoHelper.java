...
public static ProductPojo convertProductFormToProductPojo (ProductForm form,int clientId) throws ApiException {
...
public static ProductData convertPojoToData(ProductPojo pojo, InventoryPojo inventoryPojo) throws ApiException {
    ProductData product = new ProductData();
    product.setBarcode(pojo.getBarcode());
    product.setName(pojo.getName());
    product.setPrice(pojo.getPrice());
    product.setImageUrl(pojo.getImageUrl());
    product.setQuantity(inventoryPojo.getQuantity());
    return product;
